...
boolean Adafruit_VS1053_FilePlayer::resumeCurrentFile(uint32_t pos) {
  // reset playback
...
boolean Adafruit_VS1053_FilePlayer::seekFile(boolean forward) {
uint32_t pos=getFilePosition();
//TODO: get file size and check if seek is possible
	if (forward)
	{
		pos+=1000;
